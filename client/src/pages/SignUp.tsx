...
const safeSignupError = (message?: string) => {
  if (!message) return "Não foi possível criar sua conta. Tente novamente.";
  if (message.includes("Já existe uma conta") || message.includes("Dados de cadastro")) return message;
